...
# change this depending on the current game version, or the game version you want to process.
current_version = '11.14.1'
request_url = 'https://ddragon.leagueoflegends.com/cdn/{}/data/en_US/champion.json'.format(
    current_version)
...
for key, value in champions.items():
    ...
    ids.append(value.get('id')), keys.append(
        value.get('key')), titles.append(value.get('title'))
